  ...
  const onSubmit = async (data) => {
    ...
    const requestData = {
      ...
      claimMstDetailsModel: {
        ...
        creditorIdType: data.creditorIdType,
        ...
        orgMstDetails: creditorType === "organization" ? {
          ...
          constitutionDetails: data.constitutionDetails,
          ...
          authorizedPersonContactNumber: data.authorizedPersonContactNumber,
        ...
        bankMstDetails: {
          ...
          scannedDocumentId: data.scannedDocumentId,
          auditDetails: {
            createdBy: "admin",
            lastModifiedBy: "admin",
            createdTime: Date.now(),
